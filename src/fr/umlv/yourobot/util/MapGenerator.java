...
public class MapGenerator {
	...
	public static void setWalls(Graphics2D g, int level) throws IOException{
		...
		RadialGradientPaint paint1 = new RadialGradientPaint(70, HEIGHT-100, 100, new float[]{.3f, 1f}, new Color[]{Color.BLUE, Color.BLUE});
		new Circle (world, paint1, 40, 70, HEIGHT-100);
		allPositions.add(new Vec2(70, HEIGHT-150));
		RadialGradientPaint paint2 = new RadialGradientPaint(70, HEIGHT-150, 100, new float[]{.3f, 1f}, new Color[]{Color.BLUE, Color.BLUE});
		new Circle (world, paint2, 40, 70, HEIGHT-150);
		allPositions.add(new Vec2(70, HEIGHT-100));
		RadialGradientPaint paint3 = new RadialGradientPaint(710, 70, 100, new float[]{.3f, 1f}, new Color[]{Color.GREEN, Color.GREEN});
		new Circle (world, paint3, 40, 730, 70);
